        ...
        <article class="rounded-xl bg-white p-6 sm:p-8">
            <div class="flex items-start">
                {/* <div
                    ...
                    aria-hidden="true"
                > */}
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSv_WleTXRMGNwkbnNY7mIJ1laEhl6zW3Q3Ai4OBcUkcATF5WdAJba0Q1uPJKxaG9MXY-4&usqp=CAU" />
                {/* </div> */}
                ...
                <div class="sm:ml-8">
                    ...
                    <div class="mt-4 sm:flex sm:items-center sm:gap-2">
                        <div class="flex items-center text-gray-500">
                            ...
                            <p class="ml-1 text-xs">0 comments</p>
                        </div>
                        ...
                        <button type="button" class="w-20 h-19 p-1  bg-green-600 hover:bg-green-700 focus:ring-green-500 focus:ring-offset-green-200 text-white transition ease-in duration-200 text-center text-xs font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 ">
                            Read More
                        </button>
