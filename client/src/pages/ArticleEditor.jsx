    ...
    return (
        ...
        <Fragment>
            <div className="bg-red-300 flex">
                    ...
                    >
                        <div class="bg-white my-4 md:px-20 pt-6">
                            <div class=" bg-white rounded-md px-6 py-10 max-w-2xl mx-auto">
                                <h1 class="text-center text-2xl font-bold text-gray-700 mb-7">{slug ? "UPDATE POST" : "ADD POST"}</h1>
                                ...
                                <div class="space-y-4">
                                    ...
                                    {
                                        isLoading ? <button className="px-6 py-2 flex gap-4 mx-auto align-middle rounded-md text-lg font-semibold text-indigo-100 bg-indigo-600 ">Loading <Loader /> </button> :
                                            <button class=" px-6 py-2 mx-auto block rounded-md text-lg font-semibold text-indigo-100 bg-indigo-600  "> {slug ? "UPDATE POST" : "ADD POST"}</button>
                                    }
                                </div>
                            </div>
                        </div>
                ...
                <div
                    style={{ backgroundImage: `url(https://i.postimg.cc/SQZTLL23/aurora-borealis-northern-lights-night-5k-6000x3973-1680.jpg)`, objectFit: "contain" }}
